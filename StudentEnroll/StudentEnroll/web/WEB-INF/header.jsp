                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${pageContext.request.contextPath}/assets/img/26115.jpg" class="img-circle" alt="User Image"/>
                                                </div>
                                                <h4>
                                                    Support Team
                                                </h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${pageContext.request.contextPath}/assets/img/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Developers
                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/admin/Student">
                                        <i class="fa fa-gavel"></i> <span>Student</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="${pageContext.request.contextPath}/admin/Course">
                                        <i class="fa fa-globe"></i> <span>Course</span>
                                    </a>
                                </li>
